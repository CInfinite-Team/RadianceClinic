       ...
       <Slider className='overflow-hidden h-[850px] md:h-[750px] lg:h-[800px] pt-10 bg-[#FDF2FF] '   {...sliderSettings}>
        ...
        <div key={index} className='flex flex-col justify-center relative items-center md:min-h-screen w-screen bg-[#FDF2FF]  '>
            ...
            <div className='flex flex-col justify-center mb-10 items-center gap-5  '>
                ...
                <p className='text-sm sm:text-base w-[97%] md:w-[80%] lg:w-[60%] xl:w-[30%] text-center text-[#554075] z-10'>Here are some of the reviews that our patients gave us according to our treatments on Google</p>
            </div>
            ...
            <div className='flex flex-col'>
                <h3 className='text-4xl text-[#CDAE62] font-ElMessiri z-10'>{data.Name}</h3>
                <p className='text-[#554075] text-center z-10'>{data.Position}</p>
            </div>

            <p className='text-[#554075] text-center w-[90vw] lg:w-[76vw] xl:w-[54vw] 2xl:w-[51%] z-10 '>‘‘{data.Review}’’</p>
            </div>
        </div>
      )) }
