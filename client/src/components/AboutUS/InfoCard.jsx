        ...
        <div className='flex flex-col items-center justify-center px-6 py-4 infocardshadow rounded-md xl:px-8 w-fit h-fit xl:py-4  bg-[#FCEBFF] '>
            ...
            <div className='flex flex-col items-center justify-center py-2 gap-5 '>
                ...
                <div className='flex gap-5 bg-white px-5 py-1 '>
                    <Link to={'https://www.instagram.com/radianceclinicnagpur/'} target='_blank' > <img loading='lazy' width="auto" height="auto" src={Instagram} alt="Barde radiance Instagram" className='2xl:w-14 2xl:h-14' /> </Link>
                    <Link to={'https://www.facebook.com/radianceclinicnagpur1/'} target='_blank' > <img loading='lazy' width="auto" height="auto" src={Facebook} alt="Barde radiance Facebook" className='2xl:w-14 2xl:h-14' /> </Link>
                    <Link to={'https://www.youtube.com/channel/UCcca28C8TbpVCiCj2sKsWmw'} target='_blank' > <img loading='lazy' width="auto" height="auto" src={Youtube} alt="Barde radiance Instagram" className='2xl:w-14 2xl:h-14' /> </Link>
                </div>
