...
const DeleteCard = ({id, title, description, category, image, username, designation, uploadDate,UserPhoto}) => {
    ...
    <div className="max-w-md bg-white border relative border-gray-300 rounded-lg shadow-lg overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col justify-between flex-grow">
        ...
        <div className="mt-4 flex flex-col  justify-between">
          ...
          <PrimaryBtn
            className = 'w-full !p-0 !py-0 justify-center  my-4 '
          ><a className='p-4 py-3' onClick={() => setShowDetails(!ShowDetails)}>View Blog</a></PrimaryBtn>
          <PrimaryBtn
            className = 'w-full !p-0 bg-[#e22d2d] border-[#e22d2d] hover:text-[#e22d2d] !py-0 justify-center  '
          ><a className='p-4 py-3' onClick={SetShowPopUp(true)}>Delete Blog</a></PrimaryBtn>
        </div>
      </div>
    </div>
  );
