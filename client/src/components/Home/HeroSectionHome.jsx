...
function HeroSectionHome() {
  ...
  return (
    ...
    <div className='w-screen  min-h-screen HeroGradient  flex justify-end md:items-end'>
        <img src={Plant} alt="" className='animate-float absolute hidden lg:block w-[250px] xl:w-auto 2xl:w-[190px] top-10 left-6  xl:top-7 2xl:top-14 xl:left-20' />
        <img src={sparkling} alt="" className='animate-sparkle absolute hidden lg:block 2xl:w-[80px] top-48 2xl:top-44 left-1/2 -translate-x-28' />
       <div className='flex flex-col lg:flex-row relative justify-between w-full ml-5 xl:ml-20 2xl:ml-36 items-center gap-4 '>
        <div className={`flex flex-col mt-32  lg:-translate-y-[30%] xl:-translate-y-[20%] 2xl:-translate-y-[12%] gap-11  transition-all duration-1000 transform  ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'} `}>
            ...
            <div className='flex flex-col md:flex-row gap-7 items-center animate-fadeIn animation-delay-400 '>
                ...
                <button className='p-4 rounded-full bg-white hover:rotate-45 transition-transform duration-500'><img src={TiledArrow} alt="" /></button>
            </div>
