          ...
          <div className="flex items-center h-20 relative">
            ...
            <div className="hidden lg:flex gap-10 xl:gap-20 flex-1 justify-start">
              ...
              <div className="relative group">
                <Link to="/services" className="text-black hover:text-[#725B98] flex items-center">
                  Services
                  <svg className="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 12l-5-5h10z"/></svg>
                </Link>
                <ul className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
            ...
            <div className="hidden lg:flex gap-14 xl:gap-24 flex-1 justify-end">
              ...
              <div className="relative group">
                ...
                <ul className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
